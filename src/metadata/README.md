 ...
 * [lsfo.yml](lsfo.yml)
     * Determines how your purl.obolibrary.org/obo/lsfo/ redirects will be handled
     ...
     * Paste in the contents of [lsfo.yml](lsfo.yml)
 ...
 * [lsfo.md](lsfo.md)
     ...
     * Paste in the contents of [lsfo.md](lsfo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
